            ...
            <Container>
                <Row>
                    <Col xs="12" sm="12" md="7" lg="7">
                        <div id="data"></div> 
                        <br></br>
                        <p>(Data: <a href="https://api.covid19api.com/summary" target="_blank">https://api.covid19api.com/summary</a>)</p>
                        <img src="https://osha.europa.eu/sites/default/files/corona_info_0.png" width="80%"></img>
                        <br></br>
                        <br></br>
                        <hr></hr>
                    </Col>
