...
export const listproductSlice = createSlice({
  ...
  initialState: {
    ...
    product: [
      ...
      {productID: 6, productName: 'Men\'s T-Shirt 3', price: 232, discount: 15, status: 'Out of stock', rate: 5, description: 'Description default', imagePath: '', subcategoriesID: 2, inCart: false, numberInCart: 0},
      ...
      {productID: 13, productName: 'Men\'s Short 1', price: 150, discount: 20, status: 'Out of stock', rate: 0, description: 'Description default', imagePath: '', subcategoriesID: 5, inCart: false, numberInCart: 0},
